...
sudo npm install -g tern js-beautify eslint babel-eslint remark remark-lint-first-heading-level remark-lint typescript tslint typescript-formatter vmd

sudo python3 -m pip install flake8 anaconda-mode autoflake hy mycli
