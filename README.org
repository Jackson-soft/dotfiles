...
没有 ~key-bindings.zsh~ 这个文件，所以需要单独来下载这个文件，即添
加 =dl'https://raw.githubusercontent.com/junegunn/fzf/master/shell/key-bindings.zsh -> key-bindings.zsh' src'key-bindings.zsh'= 。
